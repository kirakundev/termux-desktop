...
complete -c x0vncserver -o ClientWaitTimeMillis -d 'Time in milliseconds to wait for a viewer which is blocking the server'
complete -c x0vncserver -o AcceptCutText
complete -c x0vncserver -o SendCutText
complete -c x0vncserver -o MaxCutText -d 'Currently unused'
